...
var Person = (function () {
  ...
  _createClass(Person, [{
    ...
    value: function init() {
      ...
      this.age = _mithril2['default'].prop(data.age);
    }
  }]);
